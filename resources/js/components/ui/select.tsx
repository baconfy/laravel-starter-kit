...
function SelectTrigger({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Trigger>) {
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                'rounded clickable bg-transparent outline-none cursor-pointer border-primary border-2 w-full h-12 px-4',
                'transition-[color,box-shadow]',
                'flex items-center justify-between font-bold',
                'data-[placeholder]:text-primary',
                '[&_svg:not([class*=\'text-\'])]:text-primary [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=\'size-\'])]:size-4 [&>span]:line-clamp-1',
...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
    return (
        <SelectPrimitive.Item
            ...
            className={cn(
                'rounded relative flex w-full cursor-pointer items-center font-bold outline-hidden select-none py-1.5 pr-8 pl-2 gap-2',
